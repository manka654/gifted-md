...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~a5FJbOCwBjsB6SBfpHsW", // Add sess Id here especially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "252770980889", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "252682642802", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "rule breaker", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "rule breaker", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "lukas-md💜", // Added // Input Yours custom...
...
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "rule breaker creates things that creates other things",
